...
Release Web : https://github.com/IUT-Blagnac/sae-3-01-devapp-g2a-8/releases/tag/Web_V0.2[v0.2]
Release IOT : https://github.com/IUT-Blagnac/sae-3-01-devapp-g2a-8/releases/tag/IOT_V0.2[v0.2]
...
- Version courante : https://github.com/IUT-Blagnac/sae-3-01-devapp-g2a-8/releases/tag/Web_V0.2[v0.2]
...
- Lien vers les https://github.com/IUT-Blagnac/sae-3-01-devapp-g2a-8/tree/master/Documentation%20Web/Tests[tests]
- Indicateurs de qualité du code (dette technique) *(à venir)*

=== Partie IOT (Java-Python)
- Version courante : https://github.com/IUT-Blagnac/sae-3-01-devapp-g2a-8/releases/tag/IOT_V0.2[v0.2]
...
- Lien vers les https://github.com/IUT-Blagnac/sae-3-01-devapp-g2a-8/tree/master/Documentation%20IOT/Tests[tests]  
- Indicateurs de qualité du code (dette technique) *(à venir)*
